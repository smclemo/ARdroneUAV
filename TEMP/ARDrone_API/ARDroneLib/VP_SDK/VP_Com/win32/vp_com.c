...
/*#ifndef NO_COM
    ...
    if(vp_com->type == VP_COM_BLUETOOTH)
    {
      vp_com->init                    = (VP_COM_x_init) vp_com_bt_init;
      vp_com->shutdown                = (VP_COM_x_shutdown) vp_com_bt_shutdown;
      vp_com->network_adapter_lookup  = (VP_COM_x_network_adapter_lookup) vp_com_bt_network_adapter_lookup;
      vp_com->local_config            = (VP_COM_x_local_config) vp_com_bt_local_config;
      vp_com->inquire                 = (VP_COM_x_inquire) vp_com_bt_inquire;
      vp_com->connect                 = (VP_COM_x_connect) vp_com_bt_connect;
      vp_com->disconnect              = (VP_COM_x_disconnect) vp_com_bt_disconnect;
      vp_com->get_rssi                = NULL;
      vp_com->wait_connections        = (VP_COM_x_wait_connections) vp_com_bt_wait_connections;
      vp_com->open                    = (VP_COM_x_open) vp_com_bt_open;
      vp_com->close                   = (VP_COM_x_close) vp_com_bt_close;
    }
