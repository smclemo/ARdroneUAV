arm-none-linux-gnueabi-gcc -o compiled/v4l2_test2 -O3 v4l2_test/fast.c v4l2_test/fast_9.c v4l2_test/fast_10.c v4l2_test/fast_11.c v4l2_test/fast_12.c v4l2_test/nonmax.c v4l2_test/v4l2_test2.c
PAUSE
...
@ECHO OFF
  ...
  :: Run custom code
  ECHO.handler.SendKeys "chmod 777 /data/video/v4l2_test2~" >>temp_SendKeys.VBS
  ECHO.WScript.sleep 500 >>temp_SendKeys.VBS
  ECHO.handler.SendKeys "./v4l2_test2~" >>temp_SendKeys.VBS
