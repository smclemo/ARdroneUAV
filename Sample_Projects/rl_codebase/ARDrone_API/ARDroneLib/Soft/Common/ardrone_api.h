...
typedef struct _navdata_unpacked_t {
  ...
  navdata_games_t          navdata_games; //#20 new in this fw?
} navdata_unpacked_t;
 ...
 * @return void
 */
void ardrone_at_set_toy_configuration(char* param, char* value) API_WEAK;
...
/**
 * @fn     Send to drone autonomous flight mode
 * @param  isActive : 0: normal mode / 1: autonomous mode
 * @return void
 */
