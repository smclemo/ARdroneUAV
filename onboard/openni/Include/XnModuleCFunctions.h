...
XN_C_API_EXPORT const XnChar* XN_CALLBACK_TYPE __ModuleScriptGetSupportedFormat(XnModuleNodeHandle hScript)
{
...
XN_C_API_EXPORT XnStatus XN_CALLBACK_TYPE __ModuleLoadScriptFromFile(XnModuleNodeHandle hScript, const XnChar* strFileName)
{
	ModuleProductionNode* pProdNode = (ModuleProductionNode*)hScript;
	ModuleScriptNode* pScript = dynamic_cast<ModuleScriptNode*>(pProdNode);
...
XN_C_API_EXPORT XnStatus XN_CALLBACK_TYPE __ModuleLoadScriptFromString(XnModuleNodeHandle hScript, const XnChar* strScript)
{
	ModuleProductionNode* pProdNode = (ModuleProductionNode*)hScript;
	ModuleScriptNode* pScript = dynamic_cast<ModuleScriptNode*>(pProdNode);
...
XN_C_API_EXPORT XnStatus XN_CALLBACK_TYPE __ModuleScriptRun(XnModuleNodeHandle hScript, XnNodeInfoList* pCreatedNodes, XnEnumerationErrors* pErrors)
{
	ModuleProductionNode* pProdNode = (ModuleProductionNode*)hScript;
	ModuleScriptNode* pScript = dynamic_cast<ModuleScriptNode*>(pProdNode);
...
XN_C_API_EXPORT void XN_CALLBACK_TYPE __ModuleGetScriptNodeInterface(XnModuleScriptNodeInterface* pInterface)
{
	__ModuleGetProductionNodeInterface(pInterface->pProductionNode);
