...
} __attribute__ ((packed)) navdata_raw_measures_t;
...
} __attribute__ ((packed)) navdata_gyros_offsets_t;
...
typedef struct _navdata_euler_angles_t {
  ...
  float32_t   theta_a;
  float32_t   phi_a;
} __attribute__ ((packed)) navdata_euler_angles_t;
...
typedef struct _navdata_references_t {
  ...
  int32_t   ref_yaw;
  int32_t   ref_psi;
} __attribute__ ((packed)) navdata_references_t;
...
} __attribute__ ((packed)) navdata_trims_t;
...
typedef struct _navdata_rc_references_t {
  ...
  int32_t    rc_ref_gaz;
  int32_t    rc_ref_ag;
} __attribute__ ((packed)) navdata_rc_references_t;
...
} __attribute__ ((packed)) navdata_pwm_t;
...
} __attribute__ ((packed)) navdata_altitude_t;
...
} __attribute__ ((packed)) navdata_vision_raw_t;
...
typedef struct _navdata_vision_t {
  ...
  float32_t  delta_psi;
	...
	float32_t gold_x;
	float32_t gold_y;
} __attribute__ ((packed)) navdata_vision_t;
...
} __attribute__ ((packed)) navdata_vision_perf_t;
...
} __attribute__ ((packed)) navdata_trackers_send_t;
...
typedef struct _navdata_vision_of_t {
  ...
  float32_t   of_dx[5];
  float32_t   of_dy[5];
} __attribute__ ((packed)) navdata_vision_of_t;
...
typedef struct _navdata_watchdog_t {
  ...
  // +4 bytes
  int32_t    watchdog;
} __attribute__ ((packed)) navdata_watchdog_t;
...
} __attribute__ ((packed)) navdata_adc_data_frame_t;
...
} __attribute__ ((packed)) navdata_video_stream_t;
...
} __attribute__ ((packed)) navdata_games_t;
